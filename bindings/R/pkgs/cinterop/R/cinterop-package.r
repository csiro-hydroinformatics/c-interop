...
#' 0.3.0 \tab 2019-08-03 \tab Fixes to the R cinterop package, required by R 3.6+ which has likely broken the `prototype` argument in setClass. Issue #4: https://github.com/csiro-hydroinformatics/c-interop/issues/4 \cr
